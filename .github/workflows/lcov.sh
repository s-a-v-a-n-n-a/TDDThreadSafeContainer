...
lcov --directory .. --capture --output-file coverage.info --rc lcov_function_coverage=1 --rc lcov_branch_coverage=1 --rc geninfo_unexecuted_blocks=1 --ignore-errors mismatch
